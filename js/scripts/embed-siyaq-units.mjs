/**
 * تضمين وحدات السياق المحسوبة المعتمدة (١٤٠٤) بنفس معاملات تضمين الآيات
 ...
 * بنفس الشيفرة: siyaq-embeddings.bin.
 *
...
const UNITS = path.join(ROOT, "findings/siyaq-swarm/units-computed.json");
const OUT = path.join(ROOT, "js/apps/studio/public/siyaq-embeddings.bin");
