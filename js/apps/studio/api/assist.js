...
// ——— السويتش الواحد (قرار مالك 2026-07-19): NIBRAS_TIER=flash يحوّل مواضعَ
// برو المعتمدة (النسجُ النهائي هنا والمسوداتُ في compose) إلى فلاش تجربةً،
// وحذفُه أو pro يعيدها. ما هو فلاش أصلًا (جولات الأدوات والحوار) لا يُمسّ أبدًا.
// نداءُ النسج قائمٌ في الحالتين بميزانية التفكير نفسها — فالفرق النموذجُ وحده.
