...
const TASK = {
  khutba: "خطبةً كاملةً منظّمة: افتتاحٌ موجزٌ يُمهّد للموضوع ويشوّق، ثم محاورُ متتابعةٌ تُبنى على الآيات المعطاة ويُستشهَدُ فيها بها نصًّا، مع وقفاتٍ تدبّريّةٍ وعبرٍ ونظراتٍ طريفةٍ نافعةٍ تُستخرَجُ منها ومن معاني ألفاظها، ثم خاتمةٌ جامعةٌ ووصايا عمليّة.",
  post: "مقالًا مكتمِلًا متماسكًا: مقدّمةٌ تجذب، ثم عرضٌ يجمع الآيات المعطاة حول الموضوع ويربط بينها ويُبرزُ معانيَ ألفاظها بنظرٍ متجدّد، مع الاستشهاد بها نصًّا، ثم خاتمةٌ عمليّة.",
  lecture: "محاضرةً كاملةً بمحاورَ معنونة: تمهيدٌ يبيّن أهمّية الموضوع، ثم محاورُ مفصّلةٌ مبنيّةٌ على الآيات ومعاني ألفاظها مع الاستشهاد بها وتدبّرِها من نواحٍ جديدةٍ نافعة، وأمثلةٌ تطبيقيّةٌ من واقع الناس، فخلاصةٌ عمليّةٌ ووصايا.",
  summary: "تلخيصًا واضحًا منظّمًا في محاورَ ونقاط، مستندًا إلى الآيات المعطاة ومعانيها مع الإشارة إلى مواضعها.",
};
const LEN = {
